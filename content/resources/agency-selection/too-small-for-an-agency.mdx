...
- **Then reach the threshold from your own effort** — and evaluate management from there, using the rest of this hub. A useful early move is [what month one under management should look like](/resources/agency-selection/month-one-under-management) as a standard to hold any agency to when the time comes.
