...
This hub is the map; the companion guides are the detail. Read [gross vs net](/resources/pricing/gross-vs-net) first — you cannot compare offers without it. Then [what management actually costs](/resources/pricing/what-management-costs) to calibrate, [hidden fees](/resources/pricing/hidden-fees) to find the charges outside the headline, [the scope checklist](/resources/pricing/scope-checklist) to turn price into value, and [leaving an agency](/resources/pricing/leaving-an-agency) to understand the exit before you need it. And when the pricing question turns from an agency's fee to your own offers, [what a PPV has to earn to be worth sending](/resources/pricing/ppv-break-even) applies the same discipline — cost the whole thing, not the headline — to your own sends, [the offer ladder](/resources/pricing/offer-ladder) is the price architecture that lets a fixed audience spend more, and [every discount you run trains someone to wait](/resources/pricing/discount-guardrails) covers the price cuts that quietly cost you more than they make. They roll out on a dated, visible cadence — the same standard we hold the rest of the library to.
