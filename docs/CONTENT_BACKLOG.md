...
| 33 | pricing | Raising Your Subscription Price Without Torching Your Rebill Rate | Sequencing a price change — grandfathering, notice, what to add before the increase, and the rebill dip to expect and when it recovers. | ✅ Live · `/resources/pricing/raising-your-price` |
| 34 | content-ops | Stop Planning Months. Plan Two Weeks and a Backlog. | Monthly content calendars break on contact with reality; a two-week committed window plus a prioritised backlog survives illness, bans and platform changes. | ✅ Live · `/resources/content-ops/two-week-planning` |
| 35 | growth | Which Subreddits Are Worth Your Hours | A weighted fit score — rules friction, mod behaviour, verification burden, historical conversion — before you spend a month posting into dead traffic. | ✅ Live · `/resources/growth/subreddit-fit` |
